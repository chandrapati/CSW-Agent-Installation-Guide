...
| **CSW host agent (for comparison)** | `tetd` / TetSensor on the workload | Direct sensor → cluster registration | Flow + process + software inventory + CVE + (optional) enforcement |
