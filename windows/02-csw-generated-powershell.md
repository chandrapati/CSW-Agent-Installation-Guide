...
8. Starts the `CswAgent` service (and any related services)
...
| `CswAgent` started but registration is *Not Active* in UI | Activation key rejected | Regenerate the script in the UI; rerun |
